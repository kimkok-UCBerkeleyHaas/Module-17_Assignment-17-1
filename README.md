...
Colab Link : https://colab.research.google.com/github/kimkok-UCBerkeleyHaas/Module-17_Assignment-17-1/blob/main/Module-17_Assignment-17-1.ipynb
...
- Maximize the efficiency of telemarketing calls by minimizing false positives (calling individuals who won't subscribe) and maximizing true positives (successfully identifying subscribers), thereby boosting conversion rates and reducing operational costs.
- I will use **ROC-AUC** and **F1-Score** as our primary evaluation metrics to handle class imbalance while optimizing predictive power.
